...
const localized_strings = {
    ...
    wallet_create_explaination:'Please set as complicated password as possible because it would be used to encrypt the address',
    ...
    wallet_create_success_comment: 'Please keep your password safe! LivesOne Wallet does not save or provide any function of regaining/resetting the user password.',
    ...
    profile_wallet_export_warnning: 'Warning: The private key is not encrypted. We suggest you to backup it using Keystore.',
